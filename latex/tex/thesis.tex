...
\input{definitionen/abkuerzungen}
\input{definitionen/glossar}
\input{definitionen/symbole}
...
\input{kapitel/anforderungen/anforderungen-kapitel}
\input{kapitel/implementation/implementierung-kapitel}
\input{kapitel/evaluation}
\input{kapitel/zusammenfassung-ausblick}
...
\input{kapitel/anhang/jre-jdk-correlation-generator}
