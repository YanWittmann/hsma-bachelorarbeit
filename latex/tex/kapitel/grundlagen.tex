...
% FIXME-KKL: 2 (Schwachstellen-Korrelation)
%  der Begriff der Korrelation würde dann aber mit dem zu überarbeitendem Korrelationssystem überladen sein
...
In dieser Arbeit wird der Begriff \textit{Produkt} für abgrenzbare Software- oder Hardware-Artefakte (z.B.\ das \acrshort{api}-Modul von Log4J\footnote{\url{https://mvnrepository.com/artifact/org.apache.logging.log4j/log4j-api}}) verwendet; der Begriff \textit{Repräsentation} bezeichnet eine standardisierte Darstellung desselben Produkts oder spezifischer Bestandteile (wie \texttt{cpe:/a:apache:log4j}, \texttt{pkg:maven/org.apache.logging.log4j/log4j-api} oder in der Ausprägung als Datei \texttt{log4j-api-2.23.0.jar}).
