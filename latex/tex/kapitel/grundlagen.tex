...
Drittens arbeiten die aktuell bei der \metaeffektsp eingesettzen \acrshortpl{vdb}, wie die \acrshort{nvd}, nicht mit Dateihashes zur Produktidentifikation, und bringen somit keinen effektiven Mehrwert.
...
Die \acrshort{cpe} 2.3 Naming Specification definiert eine Menge an Attribut-Wert-Paaren, die sich \textit{\acrfull{wfn}} nennen.
