...
\begin{lstlisting}[caption=Beispielhafte \acrshort{wfn} als \acrshort{cpe} 2.3 Format Strings,label=lst:initial-cpe-examples-format-string,language=]
...
\begin{lstlisting}[caption=Beispielhafte \acrshort{wfn} als \acrshort{cpe} 2.2 URI,label=lst:initial-cpe-examples-uri,language=]
...
\begin{lstlisting}[caption=Ungültige \acrshort{cpe} 2.3 Format Strings aus dem \acrshort{nvd} \acrshort{cpe} Dictionary und ihre korrigierten Gegenstücke,label=lst:invalid-cpe-strings-in-dictionary,language=]
