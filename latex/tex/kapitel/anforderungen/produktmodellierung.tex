...
Die \texttt{Id} eines Artefakts ist das einzige Attribut, welches auf einem Artefakt immer gesetzt sein muss und sichert die Eindeutigkeit innerhalb eines Inventars.
...
Das Attribut \texttt{Ecosystem} in Artefakten entspricht dem \texttt{type}-Attribut in \acrshortpl{purl} und kann von den erzeugenden Prozessen nur aufgefüllt werden, wenn auch eine \acrshort{purl} angegeben ist.
