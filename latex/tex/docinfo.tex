...
\newcommand{\hsmatitelde}{Eindeutige Produktzuordnung zur Schwachstellenanalyse: Modellierung von Produkten zur Abbildung mit heterogenen Schwachstellendatenbanken}
...
\newcommand{\hsmafirma}{\metaeffekt\sffamily\ GmbH} % Firma bei der die Arbeit durchgeführt wurde
\newcommand{\hsmabetreuer}{Prof. Thomas Smits, Technische Hochschule Mannheim} % Betreuer an der Hochschule
\newcommand{\hsmazweitkorrektor}{Karsten Klein, \metaeffekt\large\sffamily\ GmbH}   % Betreuer im Unternehmen oder Zweitkorrektor
